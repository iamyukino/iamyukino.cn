...
function imgError(ele, type) {
    ...
    case 1:
        if (ele.src.includes('https://cn.gravatar.com/avatar')) {
            ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', '/statics/as-content/work/images/global/avatar.png')
        } else {
            ele.src = '/statics/as-content/work/images/global/avatar.png'
        }
        break
    case 2:
        ele.src = '/statics/as-content/work/images/global/avatar.png'
        break
    case 3:
        ele.src = '/statics/as-content/work/images/global/image-404.png'
        break
    default:
        ele.src = '/statics/as-content/work/images/global/image-404.png'
    }
        ...
        for (var i = 0; i < this.files.length; i++) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="/statics/as-content/work/images/global/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />')
                    lazyload()
...
function checkBgImgCookie() {
    ...
    if (bgurl != '') {
        if (bgurl == '/statics/as-content/work/images/sakura/sakura.png' || bgurl == '/statics/as-content/work/images/sakura/plaid.jpg' || bgurl == '/statics/as-content/work/images/sakura/star.png' || bgurl == '/statics/as-content/work/images/sakura/point.png' || bgurl == '/statics/as-content/work/images/sakura/little-monster.png') {
...
function checkEffectsCookie() {
    ...
    if (efurl) {
        ...
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/sakura.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/snow.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/line.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/piao.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/coderain.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/pointrain.js")
    ...
    if (efurl) {
        var effect = document.createElement("script")
        effect.setAttribute("src", "/statics/as-includes/work/cdn-cgi/sakura/raindrop.js")
...
$(document).ready(function() {
    ...
    changeBG('#sakura-bg', '/statics/as-content/work/images/sakura/sakura.png')
    changeBG('#gribs-bg', '/statics/as-content/work/images/sakura/plaid.jpg')
    changeBG('#pixiv-bg', '/statics/as-content/work/images/sakura/star.png')
    changeBG('#KAdots-bg', '/statics/as-content/work/images/sakura/point.png')
    changeBG('#totem-bg', '/statics/as-content/work/images/sakura/little-monster.png')
    ...
    $('.skin-menu #dark-bg').click(function() {
        mashiro_global.variables.skinSecter = true
        mashiro_global.variables.isNight = true
        $('body').css('background-image', 'url(/statics/as-content/work/images/sakura/dark_bg9.jpg)')
        ...
        $('#banner_wave_2').addClass('banner_wave_hide_fit_skin')
        closeSkinMenu()
        setCookie('bgImgSetting', '/statics/as-content/work/images/sakura/dark_bg9.jpg', 30)
    })
